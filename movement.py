...
turtle_controls = { #keys so i can switch which turtle to control
    '1': 'turtle1',
    '2': 'turtle2',
    '3': 'turtle3',
    '4': 'turtle4'
...
attack_radius = 2.0  #attack radius
current_turtle = 'turtle1'  # Default to turtle1 initially


def get_key():  #Function to take user keyboard input
...
def attack(turtle_name):
    ...
    attack_msg = create_attack_message(turtle_name, 0.0, 0.0)  # Example coordinates
...
if __name__ == '__main__':
    ...
    try:
        while not rospy.is_shutdown():
            ...
            if key in turtle_controls: # Can switch turtle being controlled using key (1, 2, 3, 4)
